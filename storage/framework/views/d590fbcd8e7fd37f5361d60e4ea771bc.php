  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="<?php echo e(asset('images/logo/AndinTransport_linear.png')); ?>" width="160" height="50" alt="Home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <a href="#" class="logo">
          <img src="<?php echo e(asset('images/logo/AndinTransport_linear.png')); ?>" width="160" height="50" alt="Grilli - Home">
        </a>
  ...
  </header><?php /**PATH C:\laragon\www\Andin\resources\views/components/header.blade.php ENDPATH**/ ?>