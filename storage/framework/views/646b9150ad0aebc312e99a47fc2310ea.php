    ...
    <article>
      ...
      <section class="hero text-center" aria-label="home" id="home">
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?php echo e(asset('images/hero/hero1-modified.JPEG')); ?>" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?php echo e(asset('images/hero/hero2-modified.jpeg')); ?>" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?php echo e(asset('images/hero/hero3-modified.jpeg')); ?>" width="1880" height="950" alt="" class="img-cover">
            </div>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          ...
          <ul class="grid-list">
              ...
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?php echo e(asset('images/product/innova-diesel.jpg')); ?>" width="285" height="336" loading="lazy" alt="Innova Diesel"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?php echo e(asset('images/product/mercedesBenz-sprinter.jpeg')); ?>" width="285" height="336" loading="lazy" alt="Sprinter"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?php echo e(asset('images/product/innova-g.jpeg')); ?>" width="285" height="336" loading="lazy" alt="Innova-g"
                      class="img-cover">
                  </figure>
                </a>
          ...
          <img src="<?php echo e(asset('images/shape-1.png')); ?>" width="246" height="412" loading="lazy" alt="shape"
            class="shape shape-1 move-anim">
          <img src="<?php echo e(asset('images/shape-2.png')); ?>" width="343" height="345" loading="lazy" alt="shape"
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            ...
            <img src="<?php echo e(asset('images/about/about1.jpeg')); ?>" width="570" height="570" loading="lazy" alt="about banner"
              class="w-100" data-parallax-item data-parallax-speed="1">

            <div class="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
              <img src="<?php echo e(asset('images/logo/AndinTransportLogo.png')); ?>" width="285" height="285" loading="lazy" alt=""
                class="w-100">
            </div>

          </figure>

          <img src="<?php echo e(asset('images/shape-3.png')); ?>" width="197" height="194" loading="lazy" alt="" class="shape">
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <img src="<?php echo e(asset('images/icon/location.png')); ?>" width="50" height="50" loading="lazy" alt="badge" class="abs-img">
      ...
      <section class="section menu" aria-label="menu-label" id="menu">
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?php echo e(asset('images/product/png/innova-diesel.png')); ?>" width="100" height="100" loading="lazy" alt="Innova Diesel"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?php echo e(asset('images/product/png/innova-g.png')); ?>" width="100" height="100" loading="lazy" alt="Innova G"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?php echo e(asset('images/product/png/innova-trd-diesel.png')); ?>" width="100" height="100" loading="lazy" alt="Innova Trd Diesel"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?php echo e(asset('images/product/png/innova-venturer.png')); ?>" width="100" height="100" loading="lazy" alt="Innova Venturer"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?php echo e(asset('images/product/png/toyota-fortuner-gr.png')); ?>" width="100" height="100" loading="lazy" alt="Fortuner GR"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?php echo e(asset('images/product/png/toyota-hiace-luxury.png')); ?>" width="100" height="100" loading="lazy" alt="Toyota Hiace"
                    class="img-cover">
                </figure>
          ...
          <img src="<?php echo e(asset('images/shape-5.png')); ?>" width="921" height="1036" loading="lazy" alt="shape"
            class="shape shape-2 move-anim">
          <img src="<?php echo e(asset('images/shape-6.png')); ?>" width="343" height="345" loading="lazy" alt="shape"
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?php echo e(asset('images/blog/dpr.jpeg')); ?>" width="350" height="450" loading="lazy"
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?php echo e(asset('images/blog/smelter.jpeg')); ?>" width="350" height="450" loading="lazy"
                    alt="Flavour so good you’ll try to eat with your eyes." class="img-cover">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?php echo e(asset('images/blog/Document-3.JPG')); ?>" width="350" height="450" loading="lazy"
                    alt="Flavour so good you’ll try to eat with your eyes." class="img-cover">
...
</html><?php /**PATH C:\laragon\www\Andin\resources\views/index.blade.php ENDPATH**/ ?>